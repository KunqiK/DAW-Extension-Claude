...
- ⏳ **Pending user test:** open a MIDI → edit notes (add/move/resize/transpose/undo) → fill lyrics → Export; and confirm the new UI/edit-bar feels right. (.exe refreshed on the new build.)

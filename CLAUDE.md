...
- ⏳ **Pending user test:** open a MIDI → edit notes (add/move/resize/transpose/undo), Ctrl/Alt+wheel to zoom, fill lyrics → Export; confirm the new geometric look + bigger roll feel right. (.exe refreshed on the new build.)

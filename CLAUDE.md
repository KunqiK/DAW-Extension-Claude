...
- ⏳ **Pending user test:** launch to watch the intro; open a MIDI → edit/zoom (Ctrl/Alt+wheel) → fill lyrics → Export; confirm the all-purple look + animation feel right. (.exe refreshed on the new build.)
